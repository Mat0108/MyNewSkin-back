    ...
    form.save((error, form) => {
        if (error) {
            ...
            const mailOptions = {
                ...
                // ],
                // attachments: [file],
                html: "Nous vous remercions d'avoir choisi nos services pour votre diagnostic, nous vous confirmons avoir bien reçu votre diagnostic. <br> <br> L'analyse de celui-ci est en cours et vous recevrez les résultats détaillés sous quelques jours. Nous vous remercions de votre patience et restons à votre disposition pour toute question complémentaire.<br> <br>   Po. <br>   po-skin.fr<br>   contact@po-skin.net"
              };
